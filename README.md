...
- Developed backend functionality for an AI-powered education and career platform: school and job brand generation, user wiki and memory flows, voice assistant and SMS conversations, job search MCP / REST APIs, and external service integrations.

- Built and optimized a dedicated job service: Fantastic Jobs and USAJOBS synchronization, semantic and Elasticsearch-backed search, location radius filtering, expired job cleanup, background processing, deployment automation, and production reliability improvements.
...
#### CreditSCRIPT (finances), [*creditscript.com*](https://creditscript.com), Madagascar / UK, Senior Python Developer, Jan 2017 – Sep 2017 (9 months)
